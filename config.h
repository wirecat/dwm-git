...
static const char col_mell_green[]  = "#599944";
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { col_gray3, col_gray1, col_gray2 },
	[SchemeSel]  = { col_gray4, col_cyan,  col_mell_green },
};

/* tagging */
static const char *tags[] = { "1", "2", "3", "4", "5", "6", "7", "8(Chat)", "9(Steam)" };
...
static Key keys[] = {
	...
	{ MODKEY,                       XK_Up,     spawn,          {.v = upsndcmd} },
	{ MODKEY,                       XK_Down,   spawn,          {.v = dwnsndcmd} },
